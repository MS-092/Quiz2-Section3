function printpdf() {
  ...
  function addLang() {
    ...
    head.innerHTML = ('<div class="language"><span><input type="checkbox" class="input-checkbox"></span><span contenteditable="true">Language name</span> - <span contenteditable="true">language level</span></div>');
    saveresume();
  }
